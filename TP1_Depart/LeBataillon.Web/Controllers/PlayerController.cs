...
namespace LeBataillon.Web.Controllers
{
    public class PlayerController : Controller
    {
        ...
        public PlayerController(MaisonReveDbContext context)
        {
            _context = context;
        }
        ...
        {
            var maisonReveDbContext = _context.Player.Include(p => p.Team);
        ...
        public async Task<IActionResult> Create([Bind("Id,NickName,Email,PhoneNumber,FirstName,LastName,Level,TeamId")] Player player)
        {
            ...
            ViewData["TeamId"] = new SelectList(_context.Set<Team>(), "Id", "TeamName", player.TeamId);
            return View(player);
        }
